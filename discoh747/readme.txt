/**
  @page STM32H747I-DISCO Demonstration
 
  @verbatim
  ******************************************************************************
  * @file    readme.txt
  * @author  MCD Application Team
  * @brief   Description of STM32H747I-DISCO Full Demonstration
  ******************************************************************************
  * @attention
  *
...
STemWin TouchGFX and Embedded Wizard, and the FreeRTOS real time operating system and uses almost the whole STM32
...
package and content is to be copied (as it is) on an SDCard root using the host PC.
Then connect the SDCard on the STM32H747I-DISCO "Micro SD" connector CN12 
...
After connection of the LCD on the board, the demonstration starts by displaying an animation with the ST logo and goes
...
4- Use "STM32Cube_Demo-STM32H747I-DISCO-VX.Y.Z_FULL.hex" file provided under "Binary" with STM32CubeProgrammer
   ...
   - From Erasing and programming Menu browse to select the "STM32Cube_Demo-STM32H747I-DISCO-VX.Y.Z_FULL.hex" file
     then click on start programming
   
   You can also use the script "program_hexfile.bat" to directly program this hex file into the STM32H747I-DISCO board.
   This script will invoke the STM32CubeProgrammer with the correct QSPI flasher (MT25TL01G_STM32H747I-DISCO)  
   
5- copy the audio and video files provided under "/Media" in an SDCard storage
6- Plug/connect the Media storage: SDCard on "Micro SD" connector CN12.
...
7 - Run the demonstration
  ...
  - This demonstration runs on STM32H747Ixx and STM32H757Ixx devices.

  - This application has been tested with STM32H747I-DISCO board with LCD.
